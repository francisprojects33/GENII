...
namespace GeniiApp.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [Required(ErrorMessage = "You need to add roles first before adding a user.")]
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            ExternalLogins = (await _signInManager.GetExternalAuthenticationSchemesAsync()).ToList();
            //var role = _roleManager.FindByIdAsync(Input.AccountType.ToString()).Result;
            var role = Input.AccountType;
